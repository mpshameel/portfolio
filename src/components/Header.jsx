export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <p className="max-w-2xl mx-auto font-Ovo">Full-stack developer with expertise in both front-end and back-end systems. I delivers scalable, user-centric web and mobile solutions for global clients.I specializing in high-performance web and mobile applications.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/shameel_fullstack.pdf" download
